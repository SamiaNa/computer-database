...
public enum ComputerService {
	...
	public Optional<Computer> getComputerById(Long computerId) throws DAOException, ClassNotFoundException, ValidatorException{
		return ComputerDAOImpl.INSTANCE.getComputerById(computerId);
	}

	public Optional<Computer> createComputer(Computer computer) throws ValidatorException, ClassNotFoundException, DAOException {
