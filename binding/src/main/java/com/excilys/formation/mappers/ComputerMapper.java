...
public class ComputerMapper {
     ...
     * @throws DAOException
     */
    public List<Computer> createComputerListFromResultSet(ResultSet res) throws MapperException{
     ...
     * @throws DAOException
     */
    public Optional<Computer> createComputerFromResultSet(ResultSet res) throws MapperException {
        try {
            if (res.next()) {
     ...
     * @throws DAOException
     */
    public Computer createComputerAfterNext(ResultSet res) throws MapperException {
        try {
